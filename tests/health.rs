...
async fn health_test() {
    ...
    let r = client.service("consul", Option::None, true, Option::None).await.unwrap();
    ...
    let r = client.service("non-existing-service", Option::None, true, Option::None).await.unwrap();
    let (snodes, meta) = (r.0, r.1);
    {
