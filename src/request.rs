...
pub fn delete<R: DeserializeOwned>(
    ...
    write_with_body(path, None as Option<Vec<u8>>, config, params, options, req)
}
...
pub fn put<T: Serialize, R: DeserializeOwned>(
    ...
    write_with_json(path, body, config, params, options, req)
}

pub fn put_data<R: DeserializeOwned>(
    path: &str,
    body: Option<Vec<u8>>,
    config: &Config,
    params: HashMap<String, String>,
...
fn write_with_json<T: Serialize, R: DeserializeOwned, F>(
    path: &str,
    body: Option<&T>,
    config: &Config,
    mut params: HashMap<String, String>,
